...
public class RewardsController {
	 ...
	 *            
	 */
    public RewardsController(@Autowired IRewardService rewardService) {
    ...
    public ResponseEntity<Rewards> save(
        ...
        return new ResponseEntity<>(rewardService.save(body), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> detail(
        ...
        if(reward.isPresent()) {
        	...
        	return new ResponseEntity<>("Reward Detail with id" + id + "not found", HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<?> update(
        ...
        if(reward.isPresent()) {
        	...
        	return new ResponseEntity<>("Reward with id" + id + "not found", HttpStatus.NOT_FOUND);
        }
