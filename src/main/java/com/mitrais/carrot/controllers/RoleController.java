...
public class RoleController {
    ...
    public ResponseEntity<Iterable<Role>> all() {
        return new ResponseEntity<Iterable<Role>>(roleService.findAllBydeletedFalse(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Role> save(
        ...
        return new ResponseEntity<Role>(roleService.save(body), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<Role> detail(
        ...
        return new ResponseEntity<Role>(model, HttpStatus.OK);
    }
    ...
    public ResponseEntity<Role> update(
        ...
        return new ResponseEntity<Role>(roleService.save(model), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ApiResponse> delete(
        ...
        return new ResponseEntity<ApiResponse>(new ApiResponse(true, "Data id : " + id + " deleted successfully"), HttpStatus.OK);
    }
}
